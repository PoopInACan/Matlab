function Raman_fit_of_Buffer_layer_with_minimized_errors(filename,refN,fitsquest,saveFile)
%% Reference file
if nargin < 2
...
% for n = 1:sizey
%     [ maximum_G(n),  maxIndex_G(n),  fwhm_G(n),  x0_G(n)] = getLorentzianParameters([1530,1650],y_shifted_flattened_subtracted(:,n),x);
%     [ maximum_D(n),  maxIndex_D(n),  fwhm_D(n),  x0_D(n)] = getLorentzianParameters([1200,1450],y_shifted_flattened_subtracted(:,n),x);
%     time_elapsed = toc;
...
switch fitsquest
    case 'Yes'
        ...
        [x_01,maximum1,fwhm1, ...
            ...
            calculateLorentzianParameters(x,y_shifted_flattened_subtracted,1);
    otherwise
...
%% Functions
    ...
    function [x_01,maximum1,fwhm1, ...
            x_02,maximum2,fwhm2, ...
            x_03,maximum3,fwhm3, ...
            x_0D,maximumD,fwhmD, ...
            x_0G,maximumG,fwhmG, ...
            x_0Dp,maximumDp,fwhmDp] = calculateLorentzianParameters(x,y,answer)
        if isequal(answer, 1)
            [ x_01,maximum1,fwhm1, ...
                x_02,maximum2,fwhm2, ...
                x_03,maximum3,fwhm3, ...
                x_0D,maximumD,fwhmD, ...
                x_0G,maximumG,fwhmG, ...
                x_0Dp,maximumDp,fwhmDp] = peakFitFuncBufferx3( x,y );
        end
    end

%% Put var in workspace
if isequal(fitsquest,'Yes')
    clearvars -except 'y' 'yref' 'y_shifted' 'yref_shifted' 'x' 'shiftnumber' 'y_shifted_flattened' ...
        ...
        'x_0D' 'maximumD' 'fwhmD' ...
        'x_0Dp' 'maximumDp' 'fwhmDp' ...
        'x_0G' 'maximumG' 'fwhmG' 'fitsquest' 'filename' 'refN' 'tsum' 'saveFile';
    ...
    putvar('y','yref','y_shifted','yref_shifted','x','shiftnumber','y_shifted_flattened',...
        ...
        'x_0D','maximumD','fwhmD',...
        'x_0Dp','maximumDp','fwhmDp',...
        'x_0G','maximumG','fwhmG','fitsquest','filename','refN','tsum');
else
    clearvars -except 'y' 'yref' 'y_shifted' 'yref_shifted' 'x' 'shiftnumber' 'y_shifted_flattened' ...
        'yref_shifted_flattened' 'yref_shifted_flattened_multiply' 'multiplyFactor'  ...
        'y_shifted_flattened_subtracted' 'fitsquest' 'filename' 'refN' 'tsum' 'saveFile';
    
    putvar('y','yref','y_shifted','yref_shifted','x','shiftnumber','y_shifted_flattened',...
        'yref_shifted_flattened','yref_shifted_flattened_multiply','multiplyFactor', ...
        'y_shifted_flattened_subtracted','fitsquest','filename','refN','tsum');
end
