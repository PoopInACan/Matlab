function influence_of_argon_flow
% Initialize variables.
filename = '/Users/Kevin/Dropbox/Matlab programs/Mat and text files/stationary_vs_gas_flow.txt';
delimiter = '\t';
startRow = 2;
...
myfig = figure(1);
clf;
theplot = plot(flow_rate,bare,'o',...
    flow_rate,buffer,'o',...
    flow_rate,one_layer,'o',...
    flow_rate,two_layer,'o',...
    flow_rate,yybare,'-.',...
    flow_rate,yybuffer,'-.',...
    flow_rate,yyone,'-.',...
    flow_rate,yytwo,'-.');
